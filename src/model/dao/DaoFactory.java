...
public class DaoFactory {
	...
	public static SellerDao createSellerDao() { // classe vai expor um metodo que retorna o tipo da interface no caso (SellerDao)
		return new SellerDaoJDBC();				// Mas internamente ela vai instanciar uma implementação. Macete para não precisar expor a implementação e sim somente a interface
	}				
			// no programa principal sera ex de instancçao "SellerDao sellerDao = DaoFactory.createSellerDao();"		
